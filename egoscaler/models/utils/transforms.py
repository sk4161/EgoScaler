...
def get_image_transforms(
    ...
    brightness_min_max: tuple = None,
    contrast_weight: float = 1.0,
    contrast_min_max: tuple = None,
    saturation_weight: float = 1.0,
    saturation_min_max: tuple = None,
    hue_weight: float = 1.0,
    hue_min_max: tuple = None,
    sharpness_weight: float = 1.0,
    sharpness_min_max: tuple = None,
    max_num_transforms: int = None,
    random_order: bool = False,
):
